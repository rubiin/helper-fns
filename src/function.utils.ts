 ...
 */
export function removeEmpty(obj: Record<string, any> | Array<unknown>) {
 ...
 */
export function difference(a: unknown[], b: unknown[]): unknown[] {
 ...
 */
export function common(a: unknown[], b: unknown[]): unknown[] {
  return a.filter(c => b.includes(c))
}
 ...
 * @returns [1, 2, 3, 4, 5]
 */
export function dropRight(arr: unknown[], n = 1): unknown[] {
 ...
 */
export function dropWhile(arr: string | unknown[], func: (arg0: any) => any) {
